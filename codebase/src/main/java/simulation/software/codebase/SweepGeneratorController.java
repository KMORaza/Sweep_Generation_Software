...
public class SweepGeneratorController {
    ...
    public void initialize() {
        ...
        phaseButton.setOnAction(e -> showPhaseAnalyzer());
        ...
        phaseButton.getStyleClass().add("retro-button");
    ...
    private void showPhaseAnalyzer() {
        if (phaseAnalyzer == null) {
            phaseAnalyzer = new PhaseAnalyzer();
            phaseAnalyzer.show();
            phaseAnalyzer.startUpdating();
        }
    }
    ...
    public void closePhaseAnalyzer() {
        if (phaseAnalyzer != null) {
            phaseAnalyzer.close();
            phaseAnalyzer = null;
        }
    ...
    private void updateWaveform() {
        ...
        // Update phase analyzer if open
        if (phaseAnalyzer != null) {
            phaseAnalyzer.setWaveformData(waveform, sweepType.equals("Time") ? sweepTime : 0.02);
        }
    }
}